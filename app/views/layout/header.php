...
<header x-data="{ isScrolled: false }" x-init="window.addEventListener('scroll', () => { if (window.scrollY > 50) { isScrolled = true } else { isScrolled = false } })">
    <nav :class="isScrolled ? 'bg-blue-500 shadow-md' : 'bg-transparent'" class="fixed top-0 left-0 w-full p-4 transition-all duration-300">
        <div class="container mx-auto flex items-center justify-between">
            <a href="#" class="text-white text-2xl font-semibold">Manga Management</a>
